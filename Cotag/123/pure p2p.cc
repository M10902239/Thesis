...
main (int argc, char *argv[])
{
  ...
  NodeContainer n3n4 = NodeContainer(apWifiNode, staWifiNode);
...
/* Create p2p Network Devices (P2PNetDevice) */
  ...
  // p2pHelper.SetQueue("ns3::DropTailQueue",  "MaxPackets",UintegerValue(100000000));
/* Create p2p Network Devices (P2PNetDevice) */
  NetDeviceContainer s2e = p2pHelper2.Install (n3n4);
  ...
  Ipv4InterfaceContainer apInterface = address.Assign (s2e);
